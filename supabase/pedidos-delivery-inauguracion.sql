-- ============================================================
-- DELIVERY INAUGURACIÓN: gratis desde S/10, S/1 si es menor
-- Ejecutar en Supabase (reemplaza lógica de zonas cerca/lejos)
-- ============================================================

-- Quitar versión vieja con p_zona_delivery si existía
...
SELECT 'Delivery inauguración instalado' AS resultado;
